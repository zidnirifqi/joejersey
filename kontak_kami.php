...
<title>Joe Jersey's - Kontak Kami</title>
			...
			<div id="templatemo_menubar">
				<div id="top_nav" class="ddsmoothmenu">
					<ul>
						...
						<li><a href="kontakkami.php" class="selected">Kontak Kami</a></li>
					</ul>
					<br style="clear: left" />
					...
					?>
						<table width="100%" cellpadding="5" border="0">
							...
							<tr>
								<td>
									<b>Handphone :</b><br>
									<?php echo nl2br($hasil['nomer_handphone']);?>
								</td>
							</tr>
						</table><br><br>
