<?php session_start();
	...
	if(isset($_POST['submit'])){
		...
		if (empty($nama_produk) && empty($harga_produk)) {
			...
			mysql_query("INSERT INTO tabel_produk VALUES('','$nama_produk','$kategori','$harga_produk','$foto_produk')");
...
<title>Joe Jersey's - Tambah Produk</title>
					...
					<form method="post" action="" enctype="multipart/form-data" >
						<table cellpadding="2" cellspacing="2" border="0" width="600">
							<tr>
								<td width="45">Nama</td>
								<td width="15">:</td>
								<td width="540"><input type="text" size="30" name="nama_produk"></td>
							</tr>
							<tr>
								...
								<td width="540">
									<select name="kategori">
										...
										?>
										<option value="<?=$hasil_satu['kategori'];?>"><?=$hasil_satu['kategori']?></option>
										<?php
											}
										?>
							...
							<tr>
								...
								<td width="15">:</td>
								<td width="540">Rp <input type="text" size="15" name="harga_produk"> ,00</td>
							</tr>
							<tr>
								<td width="45">Foto</td>
								<td width="15">:</td>
								<td width="540"><input type="file" name="foto_produk" size="30" accept="image/jpeg" /></td>
							</tr>
							<tr>
								<td width="45">&nbsp;</td>
								<td width="15">&nbsp;</td>
