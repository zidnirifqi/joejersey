		...
		<div id="templatemo_wrapper">
			...
			<div id="templatemo_main">
				...
				<div id="content" class="float_r">
					...
					<h1>Frequency Ask and Question</h1>
					<?php
						include "koneksi.php";
						$query = mysql_query("SELECT * FROM tabel_faq");
						while($data = mysql_fetch_array($query)) {
					?>
							<b>Tanya : <?php echo nl2br($data['tanya_faq']);?></b><br>
							Jawab : <?php echo nl2br($data['jawab_faq']);?><br><br>
					<?php
						}
					?><br><br>
