...
<title>Joe Jersey's - Tambah Kategori</title>
					...
					<form method="post" action="" >
						<table cellpadding="2" cellspacing="2" border="0" width="270">
							<tr>
								...
								<td width="10">:</td>
								<td width="140"><input type="text" name="kategori"></td>
							</tr>
							<tr>
								<td colspan="3">
									<?php
										...
										if(isset($kategori)){
											if($kategori == ""){
												...
												include "koneksi.php";
												$insert = "INSERT INTO tabel_kategori VALUES ('','$kategori')";
							...
							<tr>
								<td width="110">&nbsp;</td>
								<td width="10">&nbsp;</td>
								<td width="140" align="left"><input name="submit" type="submit" value=" Tambah " /></td>
							</tr>
						</table>
					</form>
					<br>
