<?php
	...
	$data = mysql_fetch_array(mysql_query("select * from tabel_kategori where id_kategori='$id_kategori'"));
?>
...
<title>Joe Jersey's - <?php echo $data['kategori'];?></title>
		...
		<div id="templatemo_wrapper">
			...
			<div id="templatemo_main">
				...
				<div id="content" class="float_r">
					...
					<?php
						$data_satu = mysql_fetch_array(mysql_query("select * from tabel_kategori where id_kategori='$id_kategori'"));
					?>
					<h1>Kategori <?php echo $data_satu['kategori'];?></h1>
					<div class="product_box">
						<table width="100%" border="0" cellpadding="10" cellspacing="0">
								<?php
									include "koneksi.php";
									$query = mysql_query("SELECT * FROM tabel_produk WHERE kategori='$data_satu[kategori]' ORDER BY id_produk ASC");
