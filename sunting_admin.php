				...
				<div id="content" class="float_r">
					...
					<table width="310" border="1" cellpadding="3" cellspacing="1">
						<tr>
							...
							<th width="165" align="center" bgcolor="#dadada"><font size="2">Username</font></th>
							<th width="110" align="center" bgcolor="#dadada"><font size="2">Aksi</font></th>
						</tr><br>
						<?php
							$sql = mysql_query("SELECT * FROM tabel_loginadmin order by id_user asc");
							while($row = mysql_fetch_array($sql)){
						?>
						<tr>
							<td align="center"><font size="2"><?php echo $c=$c+1;?>.</font></td>
							<td align="center"><font size="2"><?php echo $row['username'];?></font></td>
							<td align="center">
							<a href="admin_ubah.php?id_user=<?php echo $row['id_user']; ?>"><font size="2">Ubah</font></a>&nbsp;&nbsp;
							<a href="admin_hapus.php?id_user=<?php echo $row['id_user']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus akun ini ?')"><font size="2">Hapus</font></a></td>
						</tr>
						<?php
						}
						?>
